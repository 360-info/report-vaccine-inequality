...
Now let's look at the UNICEF data, which also gives an idea of total doses delivered - but broken down by program.
...
Okay, looks like these total dose estimates are wildly different: UNICEF's figures are _much larger_ than OWID's. (generally on the order of 100% to 300% bigger).
